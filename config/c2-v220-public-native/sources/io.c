...
__attribute__((section(".lisp65_rt_card2b_disk"))) void io_disk_transaction_capture_mount_token(void) {
    (void)disk_transaction_mount_token_op(1);
}

__attribute__((section(".lisp65_rt_card2b_disk"))) __attribute__((noinline)) unsigned char io_disk_transaction_classify_status(unsigned char status) {
...
__attribute__((section(".lisp65_rt_card2b_disk"))) static __attribute__((noinline)) unsigned char f011_issue_write_guarded(
...
__attribute__((section(".lisp65_rt_card2b_disk"))) static unsigned char f011_write_at_guarded(unsigned char T, unsigned char S) {
    unsigned int off;
    if (!disk_transaction_mount_token_op(0))
        return LISP65_DISK_STATUS_MEDIA_CHANGED;
...
__attribute__((section(".lisp65_rt_card2b_disk"))) unsigned char io_disk_write_sector_guarded(unsigned char track, unsigned char sector) {
    unsigned int off;
...
__attribute__((section(".lisp65_rt_card2b_disk"))) unsigned char io_disk_write_sector(unsigned char track, unsigned char sector) {
