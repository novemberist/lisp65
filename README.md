...
The current release is **lisp65 1.2.2**, using **Dialect V2**.
...
Download `lisp65-1.2.2.tar.gz` from the
[v1.2.2 GitHub release](https://github.com/novemberist/lisp65/releases/tag/v1.2.2).
Release bundles are GitHub Release assets and are not stored in Git history.

```sh
tar -xzf lisp65-1.2.2.tar.gz
cd lisp65-1.2.2
python3 verify.py
```
...
See the [1.2.2 release notes](docs/releases/1.2.2.md) for the complete change
...
identity. There is no on-device disk formatter in 1.2.2.
...
**lisp65 1.2.2 is an early, hardware-validated release.** It is suitable for
...
Release 1.2.2 binds product artifact set
...
[1.2.2 release notes](docs/releases/1.2.2.md). The maintained limitations and
...
media packer. Its final gate requires all 19 roles to reproduce the sealed 1.2.2
...
- [Release Notes for 1.2.2](docs/releases/1.2.2.md)
- [Known Issues and Retired Exceptions](docs/known-issues.md)
