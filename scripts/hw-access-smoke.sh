#!/bin/sh
# Build/deploy the isolated MEGA65 HW-access smoke. No hard reset is used.
set -eu
cd "$(dirname "$0")/.."

PRG=build/lisp65-mega65-hw-access-smoke.prg
...
echo "==> starte HW-Access-Smoke (erwartet: gruener Rahmen, hw access pass 8/8)"
