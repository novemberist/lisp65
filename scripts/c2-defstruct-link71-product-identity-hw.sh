...
export C2_DEFSTRUCT_HW_OUT=build/post-promotion/link71-defstruct-product-identity-hardware-replay
...
export C2_DEFSTRUCT_HW_LABEL=Link-71-product-identity
