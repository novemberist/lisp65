#!/bin/sh
# Build/deploy the isolated MEGA65 EDMA screen+Color-RAM scroll smoke.
# No hard reset is used.
set -eu
cd "$(dirname "$0")/.."
...
echo "==> starte EDMA-Screen-Smoke (erwartet: gruener Rahmen, edma screen pass 7/7)"
