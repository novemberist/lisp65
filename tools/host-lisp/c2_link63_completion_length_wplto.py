#!/usr/bin/env python3
"""Run the one WPLTO map for the Link-63 canonical retry length."""
...
def main() -> int:
    stem = "link63-canonical-completion-length"
...
if __name__ == "__main__":
    try:
        ...
        print(
            "c2-link63-completion-length-wplto: FIRST RED: " + str(error),
            file=sys.stderr,
        )
        raise SystemExit(2)
