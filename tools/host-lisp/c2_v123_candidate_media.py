#!/usr/bin/env python3
"""Package/check the isolated v1.2.3 candidate with canonical media code."""
...
import c2_v123_candidate_product as PRODUCT  # noqa: E402


BUILD = ROOT / "build/c2.2/v1.2.3-candidate-media"
...
def main() -> int:
    ...
    if args.action == "build":
        MEDIA.check()
    print(
        "c2-v1.2.3-candidate-media: PASS "
...
if __name__ == "__main__":
    try:
        ...
        print(
            "c2-v1.2.3-candidate-media: FIRST RED: " + str(error),
            file=sys.stderr,
        )
        raise SystemExit(2)
