#!/usr/bin/env python3
"""Evaluation oracle for lib/stdlib-math.lisp on the M1 Prelude."""
...
DEFAULT_STDLIB = ROOT / "lib" / "stdlib-math.lisp"
DEFAULT_CASES = ROOT / "lib" / "tests" / "stdlib-math-eval-cases.json"
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        print("stdlib-math-eval-oracle: PASS=0 FAIL=1")
        return 1
    ...
    print(f"stdlib-math-eval-oracle: PASS={passed} FAIL={failed}")
