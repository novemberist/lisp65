#!/usr/bin/env python3
"""Class-A replay of the unconsumed self-stamp WPLTO after gate correction."""
...
OUT = ROOT / "build/c2.2/substitution/link52-phase-self-stamp-wplto-replay"
INTERNAL = EVIDENCE / (
    "c2.2-link52-phase-self-stamp-wplto-replay-internal-structural.json")
BASE_RECEIPT = EVIDENCE / (
    "c2.2-link52-phase-self-stamp-wplto-replay-base-receipt.json")
RECEIPT = EVIDENCE / "c2.2-link52-phase-self-stamp-wplto-replay-receipt.json"
PRELINK_RED = EVIDENCE / "c2.2-link52-phase-self-stamp-wplto-receipt.json"
...
def main() -> int:
    ...
    def authority():
        ...
        value["class_a_prelink_model_red"] = PROBE.bind(PRELINK_RED)
        return value
...
if __name__ == "__main__":
    try:
        ...
        print("c2-lite-v6-link52-phase-self-stamp-wplto-replay: FAIL: "
