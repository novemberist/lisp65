#!/usr/bin/env python3
"""Unconsumed Link-41 replay with the receipt and checker on one authority."""
...
DRIVER.OUT = ROOT / (
    ...
    "product-link-41-c2-lite-v6-roots-fronts-coresident-replay2")
DRIVER.RECEIPT = DRIVER.LINK.EVIDENCE / (
    "c2.2-product-link41-c2-lite-v6-roots-fronts-coresident-"
    "replay2-structural-receipt.json")
