#!/usr/bin/env python3
"""Prepare/bind/close the fresh v1.2.3 nine-case G5 hardware run."""
...
G5.BASE = ROOT / "build/c2.2/v1.2.3-acceptance/r5"
...
G5.RUNNER_RELEASE = ROOT / "scripts/c2-v123-g5-hw.sh"
G5.FORMAT = "lisp65-c2-lite-v1.2.3-G5-hardware-session-v1"
G5.TRANSPORT_FORMAT = (
    "lisp65-c2-lite-v1.2.3-media-transport-hardware-receipt-v1")
G5.REMOTE_MEDIA = "L65V123.D81"
G5.EXPECTED_BANNER = "WORKBENCH 1.2.3"
G5.CLOSE.EXPECTED_BANNER = G5.EXPECTED_BANNER
G5.CLOSE.BANNER_CLAIM = "WORKBENCH-1.2.3"
