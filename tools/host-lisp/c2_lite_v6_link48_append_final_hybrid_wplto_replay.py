#!/usr/bin/env python3
"""Class-A replay after the zero-link Hybrid authority-preflight First Red."""
...
OUT = ROOT / (
    "build/c2.2/substitution/link48-append-final-hybrid-wplto-class-a-replay")
INTERNAL = EVIDENCE / (
    "c2.2-link48-append-final-hybrid-wplto-class-a-replay-internal.json")
RECEIPT = EVIDENCE / (
    "c2.2-link48-append-final-hybrid-wplto-class-a-replay-receipt.json")
