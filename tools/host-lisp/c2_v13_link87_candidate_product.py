#!/usr/bin/env python3
"""Build/check the v1.3.0 repeated Ship-timebase successor as Link 87."""
...
LINK = 87
BUILD = ROOT / "build/c2.3/v1.3.0-candidate-product-link87-r1"
...
def freight_gates() -> dict[str, Any]:
    ...
    PREV.require(
        ...
        and card["target_runtime"]["retired_a1_a2_reader_absent"] is True
        and boot["status"] == "passed-ship-owned-repeated-frame-clock"
        ...
        "Link-87 freight authority drift",
    )
    return {
        "mode": "v1.3-Ship-repeated-timebase-successor",
        "summaries": summaries,
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"c2-v1.3.0-link87-candidate-product: FIRST RED: {error}",
            file=sys.stderr,
        )
        raise SystemExit(2)
