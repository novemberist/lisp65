#!/usr/bin/env python3
"""Prepare/bind/close the fresh v1.2.4 nine-case G5 hardware run."""
...
G5.BASE = ROOT / "build/c2.2/v1.2.4-acceptance/r5"
...
G5.RUNNER_RELEASE = ROOT / "scripts/c2-v124-g5-hw.sh"
G5.FORMAT = "lisp65-c2-lite-v1.2.4-G5-hardware-session-v1"
G5.TRANSPORT_FORMAT = (
    "lisp65-c2-lite-v1.2.4-media-transport-hardware-receipt-v1")
G5.REMOTE_MEDIA = "L65V124.D81"
