#!/usr/bin/env python3
"""Prove the v1.2.3 candidate media set in two varied fresh checkouts."""
...
BASE.FORMAT = "lisp65-c2-lite-v1.2.3-media-product-reproducibility-v1"
BASE.BUILD_COMMANDS = (
    (
        "python3",
...
BASE.MEDIA_MANIFEST_RELATIVE = Path(
    "build/c2.2/v1.2.3-candidate-media/candidate-manifest.json")
