#!/usr/bin/env python3
"""Package/check the v1.4 Link-90 VIC-unlock successor media."""
...
import c2_v14_link90_candidate_product as PRODUCT  # noqa: E402


BUILD = ROOT / "build/c2.3/v1.4.0-candidate-media-link90-r1"
...
def main() -> int:
    ...
    if args.action == "build":
        MEDIA.check()
    print(
        "c2-v1.4.0-link90-candidate-media: PASS "
...
if __name__ == "__main__":
    try:
        ...
        print(f"c2-v1.4.0-link90-candidate-media: FIRST RED: {error}",
              file=sys.stderr)
        raise SystemExit(2)
