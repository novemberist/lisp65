#!/usr/bin/env python3
"""Evaluation oracle for lib/stdlib-control.lisp on the M1 Prelude."""
...
DEFAULT_STDLIB = ROOT / "lib" / "stdlib-control.lisp"
DEFAULT_CASES = ROOT / "lib" / "tests" / "stdlib-control-eval-cases.json"
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        print("stdlib-control-eval-oracle: PASS=0 FAIL=1")
        return 1
    ...
    print(f"stdlib-control-eval-oracle: PASS={passed} FAIL={failed}")
