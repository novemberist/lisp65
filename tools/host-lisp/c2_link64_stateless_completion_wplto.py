#!/usr/bin/env python3
"""Run the sole WPLTO map for Link 64 stateless completion length."""
...
def main() -> int:
    stem = "link64-stateless-completion-length"
...
if __name__ == "__main__":
    try:
        ...
        print(
            "c2-link64-stateless-completion-wplto: FIRST RED: " + str(error),
            file=sys.stderr,
        )
        raise SystemExit(2)
