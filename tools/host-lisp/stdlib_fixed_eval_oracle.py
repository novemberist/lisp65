#!/usr/bin/env python3
"""Evaluation oracle for lib/stdlib-fixed.lisp on the M1 Prelude."""
...
DEFAULT_STDLIB = ROOT / "lib" / "stdlib-fixed.lisp"
DEFAULT_CASES = ROOT / "lib" / "tests" / "stdlib-fixed-eval-cases.json"
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        print("stdlib-fixed-eval-oracle: PASS=0 FAIL=1")
        return 1
    ...
    print(f"stdlib-fixed-eval-oracle: PASS={passed} FAIL={failed}")
