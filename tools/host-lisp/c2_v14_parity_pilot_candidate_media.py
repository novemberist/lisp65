#!/usr/bin/env python3
"""Package/check the v1.4 Link-89 parity-pilot device media."""
...
import c2_v14_parity_pilot_candidate_product as PRODUCT  # noqa: E402


BUILD = ROOT / "build/c2.3/v1.4.0-candidate-media-link89-r1"
...
def main() -> int:
    ...
    if args.action == "build":
        MEDIA.check()
    print(
        "c2-v1.4.0-link89-candidate-media: PASS "
...
if __name__ == "__main__":
    ...
    except (MEDIA.MediaError, CAN.CanonicalError, RuntimeError, OSError,
            ValueError, KeyError, json.JSONDecodeError) as error:
        print(f"c2-v1.4.0-link89-candidate-media: FIRST RED: {error}",
              file=sys.stderr)
        raise SystemExit(2)
