#!/usr/bin/env python3
"""Evaluation oracle for lib/stdlib-strings.lisp on the M1 Prelude."""
...
DEFAULT_STDLIB = ROOT / "lib" / "stdlib-strings.lisp"
DEFAULT_CASES = ROOT / "lib" / "tests" / "stdlib-string-eval-cases.json"
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        print("stdlib-string-eval-oracle: PASS=0 FAIL=1")
        return 1
    ...
    print(f"stdlib-string-eval-oracle: PASS={passed} FAIL={failed}")
