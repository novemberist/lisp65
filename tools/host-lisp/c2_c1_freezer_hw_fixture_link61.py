#!/usr/bin/env python3
"""Run C1 Cutpoints 3/4 on the sealed Link-61 product identity."""
...
import c2_c1_freezer_carrier_link61 as CARRIER  # noqa: E402
import c2_c1_freezer_hw_fixture_link60 as BASE  # noqa: E402
import c2_link61_v4_frame_seal_pure_replay as REPLAY  # noqa: E402
...
OUT = ROOT / (
    "build/c2.2/"
    "c1-freezer-hardware-link61-cutpoints3-4-NONPROMOTABLE")
HARDWARE_RECEIPT = CARRIER.EVIDENCE / (
    "c2.2-link61-C1-Freezer-four-cutpoint-hardware-receipt.json")
DEPLOYMENT_STATUS = "ready-nonpromotable-Link61-cutpoints-3-and-4"
CARRIER_STATUS = "passed-Link61-capacity-and-gates-awaiting-hardware"
CARRIER_BASENAME = (
...
def current_authority() -> dict[str, Path]:
    ...
    for name, path in paths.items():
        M.require(path.is_file(), f"missing Link-61 {name}: {path}")
    ...
    M.require(
        ...
        and replay["status"] == "passed-link61-pure-full-replay-all-gates-green"
        ...
        and carrier["construction"]["main_family_crc16"] == "0x4e98"
        and carrier["construction"]["region1_byteidentical_Link61"]
        ...
        and boot_manifest["storage"]["crc16"] == 0xDDC5
        ...
        "Link-61 C1 fixture authority is incomplete")
...
if __name__ == "__main__":
    try:
        ...
        print(
            "c2-c1-freezer-hw-fixture-link61: FAIL " + str(error),
            file=sys.stderr)
        raise SystemExit(2)
