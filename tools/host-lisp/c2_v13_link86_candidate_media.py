#!/usr/bin/env python3
"""Package/check the v1.3.0 Link-86 Ship boot-timebase media."""
...
import c2_v13_link86_candidate_product as PRODUCT  # noqa: E402


BUILD = ROOT / "build/c2.3/v1.3.0-candidate-media-link86-r1"
...
def main() -> int:
    ...
    if args.action == "build":
        MEDIA.check()
    print(
        "c2-v1.3.0-link86-candidate-media: PASS "
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"c2-v1.3.0-link86-candidate-media: FIRST RED: {error}",
            file=sys.stderr,
        )
        raise SystemExit(2)
