...
R6_SHIP_RECEIPT := tests/bytecode/dialect-v2/evidence/r6/ship-packer-receipt.json
R6_G6_SOURCE_COMMIT ?= $(shell git rev-parse HEAD)
R6_G6_PREFLIGHT_RECEIPT := tests/bytecode/dialect-v2/evidence/r6/g6-static-preflight-receipt.json
R6_G6_PROFILE_RECEIPT := tests/bytecode/dialect-v2/evidence/r6/g6-profile-applicability-receipt.json
...
R7_RELEASE_BUNDLE := releases/lisp65-1.0.0.tar.gz
R7_RELEASE_RECEIPT := releases/lisp65-1.0.0-receipt.json
