...
instructions for release 1.3.0.
...
- [Release Notes 1.3.0](releases/1.3.0.md) — current Ship, language, product, and evidence boundary
...
- [Release Notes 1.2.1](releases/1.2.1.md) — historical feature release
- [Release Notes 1.2.0](releases/1.2.0.md) — historical C2-lite foundation release
- [Release Notes 1.1.0](releases/1.1.0.md) — historical feature release
...
- [Contributing](../CONTRIBUTING.md) — curated workflow and DCO requirement
